...
Podcast.destroy_all()
garyv = Podcast.find_or_create_by(name: "The Gary Vee Audio Experience", image: "https://upload.wikimedia.org/wikipedia/commons/c/cd/Gary_Vaynerchuk_public_domain.jpg", description: "Realistic Motivation", topic_id: motivation.id)
